...
{"id":"96f083b6-6d9a-4a4b-a6fa-3cb4e2ca139d","description":"Create Production Order","cardinality":"one-to-many","dataFields":[{"name":"Order Number","type":null},{"name":"Product Design","type":null},{"name":"Quantity Required","type":null},{"name":"Due Date","type":null},{"name":"Factory Location","type":null}],"gwtDescriptions":["Given design approval, when order is created, then order exists"]}
