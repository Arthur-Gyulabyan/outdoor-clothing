...
{"id":"255f026c-2a44-4687-9ed1-a6675fb29b00","description":"Fetch Order Requirements","cardinality":"one-to-many","dataFields":[{"name":"Design Approval","type":null},{"name":"Material Stock","type":null},{"name":"Production Capacity","type":null},{"name":"Open Orders","type":null}],"gwtDescriptions":["Given design approval, when order is created, then order exists"]}
...
paths:
  /fetch-order-requirements:
    get:
      summary: Fetch Order Requirements
      tags:
        - Read Models
      responses:
        '200':
